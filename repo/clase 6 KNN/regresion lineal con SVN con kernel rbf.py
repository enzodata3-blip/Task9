...
SVM Classification with RBF (Radial Basis Function) Kernel
Uses a non-linear boundary to separate classes.
"""
...
## Fit the SVM model with RBF kernel on the training set
from sklearn.svm import SVC
svma = SVC(kernel="rbf", random_state=0)
