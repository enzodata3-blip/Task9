...
Random Forest Classification (Ensemble Learning)
Uses multiple decision trees and majority voting to classify.

Process:
    1- Select a random number K of points from the training set
    2- From these points, build a decision tree for those K data points
    3- Choose a number Ntree of trees to build and repeat steps 1 and 2
    4- To classify a new point, have each of the Ntree trees make a prediction
       of which category it belongs to, and assign the new point to the category
       with the most votes

Note: This model tends to overfit - be careful with that.
...
# 100 trees in the forest; criterion='entropy' (Gini index is the default)
